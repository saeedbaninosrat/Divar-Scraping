...
class DivarSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        information = response.xpath(
            '//*[@id="app"]/div[1]/div/div/div[1]/div[4]/div[@class="kt-base-row kt-base-row--large kt-unexpandable-row"]/*/p/text()').getall()

        information2 = response.xpath(
            '//*[@id="app"]/div[1]/div/div/div[1]/div[4]/div[@class="kt-base-row kt-base-row--large kt-unexpandable-row"]/*/span/a/text()').getall()
